...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/app_button.cyclo ./Core/Src/app_button.d ./Core/Src/app_button.o ./Core/Src/app_button.su ./Core/Src/app_cpu.cyclo ./Core/Src/app_cpu.d ./Core/Src/app_cpu.o ./Core/Src/app_cpu.su ./Core/Src/app_init.cyclo ./Core/Src/app_init.d ./Core/Src/app_init.o ./Core/Src/app_init.su ./Core/Src/app_led.cyclo ./Core/Src/app_led.d ./Core/Src/app_led.o ./Core/Src/app_led.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su
